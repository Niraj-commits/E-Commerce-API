...
router.register('admin_dashboard',AdminDashboard,basename="admin_dashboard")
router.register('supplier_dashboard',SupplierDashboard,basename="supplier_dashboard")
